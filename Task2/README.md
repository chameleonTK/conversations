...
* `1 Get Historical Trends.ipynb`: collect trends as seeding topics
* `twitter_trends.json`: a list of trends in 2022 (it was replaced by v2)
* `twitter_trends_v2.json`: a list of trends in 2022


* `2. Get Tweets from Trends.ipynb`: load tweets and coversations by trends
...
* `3. Get User Followers & Following.ipynb`: collect tweet's followers and followings 
* `followers`: lists of followers by user id
* `followings`: lists of followings by user id
* `4. Heuristically Predict Relationship .ipynb`: attempt to predict people's relationship by using number of followers and followings
